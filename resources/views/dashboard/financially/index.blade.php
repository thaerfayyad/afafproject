                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <!--begin::Add customer-->
                            <a href="{{ route('financiallies.create') }}"   class="btn btn-primary"
                        ...
                        <tbody>
                            @forelse ($datas as  $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('financiallies.edit', $data->id) }}"
...
@section('js')
    ...
    <script>
        ...
        function destroy(id, reference) {
            //JS - Axios
            axios.delete('/dashboard/financiallies/'+id)
