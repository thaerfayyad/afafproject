                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 mt-8">
                                                ...
                                                <select class="form-select form-control form-control-solid"
                                                    ...
                                                    <option value="administrator"  >اعضاء مجلس الادارة</option>
                                                    <option value="members"  >  اعضاء جمعية  العمومية </option>
                                            ...
                                            <div class="col-md-3 col-sm-12 mt-8">
...
@section('js')
    ...
    <script>
        function store() {
            ...
            axios.post('/dashboard/teams', formData, {
