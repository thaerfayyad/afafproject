            ...
            <form class="form d-flex flex-column flex-lg-row" id="create-form">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-10">
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h2>اضافة اجتماعات مجلس الادارة في جمعية قمم الشبابية</h2>
                                        </div>
                                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button"  onclick="update('{{$meeting->id}}')" class="btn btn-primary">
...
@section('js')
    ...
    <script>
        function update(id) {
            ...
            axios.post('/dashboard/meetings/'+id, formData).then(function (response) {
